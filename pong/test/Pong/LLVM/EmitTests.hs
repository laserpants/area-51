...
llvmEmitTests =
  describe "Pong.LLVM.Emit" $ do
    describe "- emitModule" $ do
      ...
      -------------------------------------------------------------------------
      passIt "4" (unsafePerformIO (emitModule (Module "Main" (transformDefs program302))) == (ExitSuccess, "401"))
      -------------------------------------------------------------------------
      passIt "5" (unsafePerformIO (emitModule (Module "Main" (transformDefs program306))) == (ExitSuccess, "402"))
      -------------------------------------------------------------------------
